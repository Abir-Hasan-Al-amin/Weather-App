...
export default function AirCondition() {
    ...
    <div className=' my-3 flex justify-center items-center'>
        <div className='w-[80%] bg-[#202B3B] rounded-lg flex p-4 sm:p-8 flex-col'>
            ...
            <div className='flex gap-2  sm:gap-4 mb-6  md:mx-16'>
                    <div>
                        <img src={temp} className=' w-6'/>
                    </div>
                    <div>
                        <p className=' text-[#AAAEB7] font-medium pb-3'>Real Feel</p>
                        <h1 className='text-[#AAAEB7] font-medium text-xl md:text-2xl lg:text-3xl  2xl:text-4xl'>{feel}&ordm;</h1>
                    </div>
            </div>
            <div className='flex gap-2 sm:gap-4 mb-4  md:mx-16'>
                    <div>
                        <img src={wind} className=' w-7'/>
                    </div>
                    <div>
                        <p className=' text-[#AAAEB7] font-medium pb-3'>Wind</p>
                        <h1 className='text-[#AAAEB7] font-medium text-xl md:text-2xl lg:text-3xl  2xl:text-4xl'>{winds} m/s</h1>
                    </div>
            </div>
            <div className='flex gap-2 sm:gap-4  sm:mb-2  md:mx-12 mx-0'>
                    <div>
                        <img src={drop} className=' w-7'/>
                    </div>
                    <div>
                        <p className=' text-[#AAAEB7] font-medium pb-3'>Pressure</p>
                        <h1 className='text-[#AAAEB7] font-medium text-xl md:text-2xl lg:text-3xl  2xl:text-4xl'>{pressure}hPa</h1>
                    </div>
            </div>
            <div className='flex gap-2 sm:gap-4 md:mx-16 sm:mb-2'>
                    <div>
                        <img src={cloud} className=' w-7'/>
                    </div>
                    <div>
                        <p className=' text-[#AAAEB7] font-medium pb-3'>Cloud</p>
                        <h1 className='text-[#AAAEB7] font-medium text-xl md:text-2xl lg:text-3xl  2xl:text-4xl'>{clouds}%</h1>
                    </div>
            </div>
        </div>
